package com.AjayaShrestha.simpleandroidsqlite;
...
public class MainActivity extends Activity implements OnClickListener
{
    ...
    Button btnAdd,btnDelete,btnModify,btnView,btnViewAll,btnShowInfo,btnClear;
    SQLiteDatabase db;
    Cursor c;
    ...
    public void onClick(View view)
    {
        switch(view.getId()){
            ...
            case R.id.btnShowInfo:
                showMessage("Student Management Application", "Developed By Azim, Modified by Ajaya");
                break;
